...
//go:generate go run github.com/deepmap/oapi-codegen/cmd/oapi-codegen --package=petstore --generate types,client,typed-client -o ../petstore-client.gen.go ../petstore-expanded.yaml
